                ...
                <div className="text-center">
                    ...
                    <form className="mt-8 space-y-6" action="#" method="POST">
                        ...
                        <p className="flex flex-col items-center justify-center mt-10 text-center text-md text-gray-500 tracking-wide">
                            ...
                            <Link to={ROUTES.LOGIN}className="text-bluesgrays-50 tracking-wide hover:text-indigo-500no-underline hover:underline cursor-pointer transition ease-in duration-300">login</Link>
                        </p>
                    </form>
                </div>
            </div>
